...
### APKiD: "PEiD" for Android Applications
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Eduardo Novella Lorente](https://img.shields.io/badge/Eduardo%20Novella%20Lorente-informational)
...
### [ART: Adversarial Robustness Toolbox for Machine Learning Models](https://github.com/Trusted-AI/adversarial-robustness-toolbox/wiki/Contributing)
...
### [ATT&CK Framework: Endpoint Detection Super Powers on the Cheap with Sysmon and Splunk](https://github.com/rmusser01/Infosec_Reference/blob/master/Draft/L-SM-TH.md)
...
### [CoffeeShot: Memory Injection to Avoid Detection](https://github.com/MinervaLabsResearch/CoffeeShot)
...
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Hiroki Hada](https://img.shields.io/badge/Hiroki%20Hada-informational) ![Tomonori Ikuse](https://img.shields.io/badge/Tomonori%20Ikuse-informational)
...
### CyBot: Open-Source Threat Intelligence Chat Bot (Bring the Threats)
...
### [Deep Exploit: Fully Automatic Penetration Test Tool Using Machine Learning](https://github.com/TheDreamPort/deep_exploit)
...
### [Dexter: The Friendly Forensics Expert on the Coinbase Security Team](https://github.com/coinbase/dexter/blob/master/doc/dexter.md)
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Hayden Parker](https://img.shields.io/badge/Hayden%20Parker-informational)
...
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Peter Weidenbach](https://img.shields.io/badge/Peter%20Weidenbach-informational)
...
### [iBombShell: Dynamic Remote Shell](https://github.com/Matir/jspassphrase/blob/master/wordlist.json)
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Pablo Gonzalez Perez](https://img.shields.io/badge/Pablo%20Gonzalez%20Perez-informational) ![Álvaro Nuñez-Romero](https://img.shields.io/badge/Álvaro%20Nuñez-Romero-informational)
...
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Yuan Zhuang](https://img.shields.io/badge/Yuan%20Zhuang-informational) ![Qinghao Tang](https://img.shields.io/badge/Qinghao%20Tang-informational)
...
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Jiawei Cao](https://img.shields.io/badge/Jiawei%20Cao-informational) ![Qinghao Tang](https://img.shields.io/badge/Qinghao%20Tang-informational)
...
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Hao Zhao](https://img.shields.io/badge/Hao%20Zhao-informational)
...
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Anirudh Anand](https://img.shields.io/badge/Anirudh%20Anand-informational) ![Mohan Kallepalli](https://img.shields.io/badge/Mohan%20Kallepalli-informational)
...
### [Lucky CAT: A Distributed Fuzzing Management Framework](https://github.com/fkie-cad/LuckyCAT)
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Thomas Barabosch](https://img.shields.io/badge/Thomas%20Barabosch-informational)
...
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Christian Heinrich](https://img.shields.io/badge/Christian%20Heinrich-informational)
...
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Ionut Gabriel Popescu](https://img.shields.io/badge/Ionut%20Gabriel%20Popescu-informational)
...
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![JIE FU](https://img.shields.io/badge/JIE%20FU-informational) ![Mingchuang Qin](https://img.shields.io/badge/Mingchuang%20Qin-informational) ![Kunzhe Chai](https://img.shields.io/badge/Kunzhe%20Chai-informational)
This is a hardware attack and defense tool platform. It will help you quickly master and implement a variety of hardware attack methods.
...
### [PingCastle: An Active Directory Security Tool](https://github.com/netwrix/pingcastle)
...
### [Prowler: Cloud Security Assessment, Auditing, Hardening, Compliance and Forensics Readiness Tool](https://github.com/prowler-cloud/prowler)
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Toni de la Fuente](https://img.shields.io/badge/Toni%20de%20la%20Fuente-informational)
...
### [RPL Attacks Framework: Attacking RPL in WSNs](https://github.com/wannadie/mendeley-parser/blob/master/output/electrical-and-electronic-engineering/electrical-and-electronic-engineering-p.csv)
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Alexandre D'Hondt](https://img.shields.io/badge/Alexandre%20D'Hondt-informational)
...
### [SCAVENGER: A Post-Exploitation Scanning/Mapping Tool](https://github.com/brianckeegan/Trailers/blob/master/joined_data.csv)
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Philip Pieterse](https://img.shields.io/badge/Philip%20Pieterse-informational)
...
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Jaroslav Lobacevski](https://img.shields.io/badge/Jaroslav%20Lobacevski-informational)
...
### [SNDBOX: The Artificial Intelligence Malware Research Platform](https://github.com/FOSDEM/video-meta/blob/master/fosdem2017/released.yml)
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Ran Dubin](https://img.shields.io/badge/Ran%20Dubin-informational) ![Ariel Koren](https://img.shields.io/badge/Ariel%20Koren-informational)
...
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Davide Cioccia](https://img.shields.io/badge/Davide%20Cioccia-informational)
...
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Shota Nakajima](https://img.shields.io/badge/Shota%20Nakajima-informational) ![Keita Nomura](https://img.shields.io/badge/Keita%20Nomura-informational)
...
### [Uitkyk: Identifying Malware via Runtime Memory Analysis](https://github.com/brompwnie/uitkyk)
...
Uitkyk is the first Android framework that allows for its implementers to identify Android malware according to the instantiated objects on the heap for a particular process. Uitkyk does not require the APK of the application to be scanned to be present to identify malicious behaviour but instead makes use of runtime memory analysis to detect behaviour which normally cannot be identified by static analysis of Android applications. Static analysis of Android applications is the default approach utilised to identify malicious applications however static analysis has certain shortcomings which Uitkyk addresses by targeting the heap. Uitkyk can be implemented as a standalone library or standalone application on mobile devices.

### [Universal Radio Hacker v2: Simulate Wireless Devices with Software Defined Radio](https://github.com/jopohl/urh)
...
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Daniel Sanchez](https://img.shields.io/badge/Daniel%20Sanchez-informational) ![Karl Hiramoto](https://img.shields.io/badge/Karl%20Hiramoto-informational)
...
### [XSSER: From XSS to RCE 3.0](https://github.com/Varbaek/xsser)
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Hans-Michael Varbaek](https://img.shields.io/badge/Hans-Michael%20Varbaek-informational)

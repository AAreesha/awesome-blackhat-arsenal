...
### [0365Squatting](https://github.com/O365Squad/O365-Squatting)
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![J Francisco Bolivar](https://img.shields.io/badge/J%20Francisco%20Bolivar-informational) ![Jose Miguel Gomez](https://img.shields.io/badge/Jose%20Miguel%20Gomez-informational)
...
### [AndroGoat: Learn Android Application Security Testing](https://github.com/OWASP/www-chapter-hyderabad/blob/master/migrated_content.md)
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Satish Patnayak](https://img.shields.io/badge/Satish%20Patnayak-informational)
AndroGoat is purposely developed open source vulnerable/insecure app using Kotlin. This app has a wide range of vulnerabilities related to certificate pinning, custom URL schemes, Android Network Security Configuration, WebViews, root detection and over 20 other vulnerabilities. Security Testers/Professionals/Enthusiasts, Developers...etc. can use this application to understand and defend the vulnerabilities in Android platform

### [ArcherySec 2.0 - Open Source Vulnerability Assessment and Management](https://github.com/archerysec/archerysec)
...
### [Batea: Digging for gold in network data](https://github.com/yarkable/Awesome-Computer-Vision-Paper-List/blob/main/NeurIPS/nips2019.md)
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Serge-Olivier Paquette](https://img.shields.io/badge/Serge-Olivier%20Paquette-informational)
...
### [BLE hardware-less hackme](https://github.com/smartlockpicking/BLE_HackMe)
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Slawomir Jasek](https://img.shields.io/badge/Slawomir%20Jasek-informational)
...
### [C2 Matrix](https://github.com/CyberSecurityUP/C2Matrix-Automation)
...
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![wasabi jrwr](https://img.shields.io/badge/wasabi%20jrwr-informational)
None

### efi_fuzz: Groundwork to the Metaphysics of coverage-guided UEFI fuzzing
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Assaf Carlsbad](https://img.shields.io/badge/Assaf%20Carlsbad-informational) ![Itai Liba](https://img.shields.io/badge/Itai%20Liba-informational)
In recent years, firmware-level attacks against UEFI have grown in popularity and became more and more complex. Prominent examples for such attacks from this year alone include CVE-2020-12890 (SMM callout vulnerability in AMD's Mini PCs), CVE-2020-10713 (BootHole, an effective bypass for Secure Boot) as well as the discovery of a new UEFI implant, dubbed MosaicRegressor. As a growing area of concern, these UEFI vulnerabilities shouldn't be taken lightly. Given any of these vulnerabilities, an attacker can get extremely stealthy persistence on the machine, while bypassing many traditional kernel-based or even hypervisor-based mitigations.
...
### [git-wild-hunt: Pwn API and leaked secrets](https://github.com/rmusser01/Infosec_Reference/blob/master/Draft/RT.md)
...
### [HosTaGe: mobile honeypots for rapid deployment](https://github.com/aau-network-security/HosTaGe)
...
### [kubeletctl: A Kubelet Client to Attack Kubernetes](https://github.com/cyberark/kubeletctl)
...
### [NEW TSURUGI LINUX ACQUIRE & DIGITAL FORENSIC ACQUISITIONS](https://github.com/drego85/HackInBo)
...
### [Powerglot: Encoding offensive scripts using polyglots for stego-malware, privilege escalation & lateral movement](https://github.com/mindcrypt/powerglot)
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Dr. Alfonso Muñoz](https://img.shields.io/badge/Dr.%20Alfonso%20Muñoz-informational)
...
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Gal BItensky](https://img.shields.io/badge/Gal%20BItensky-informational)
...
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Kai Jern Lau](https://img.shields.io/badge/Kai%20Jern%20Lau-informational) ![ChenXu Wu](https://img.shields.io/badge/ChenXu%20Wu-informational) ![ZiQiao kong](https://img.shields.io/badge/ZiQiao%20kong-informational)
...
### [SnitchDNS](https://github.com/sadreck)
...
### [Strafer: A Tool to Detect Infections in Elasticsearch Instances](https://github.com/adityaks/strafer)
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Aditya K Sood](https://img.shields.io/badge/Aditya%20K%20Sood-informational) ![Rohit Bansal](https://img.shields.io/badge/Rohit%20Bansal-informational)
...
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Fernando Mercês](https://img.shields.io/badge/Fernando%20Mercês-informational)
...
### [Threagile: Agile Threat Modeling Toolkit](https://github.com/cschneider4711)
...
![BH-ARSENAL](https://img.shields.io/badge/BH-ARSENAL-blue) ![Tool](https://img.shields.io/badge/Tool-green) ![Yaniv Agman](https://img.shields.io/badge/Yaniv%20Agman-informational) ![Idan Revivo](https://img.shields.io/badge/Idan%20Revivo-informational)
